...
hl.syntax = {
    ...
    Include = colors.Red,
    Keyword = {fg = c.red, fmt = cfg.code_style.keywords, priority = 90},
...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        ["@character"] = colors.Purple,
        ["@comment"] = {fg = c.grey, fmt = cfg.code_style.comments},
        -- ["@conditional.brackets"] = {fg = c.orange},
        ...
        ["@keyword.bracket"] =  {fg = c.red, fmt = cfg.code_style.keywords},
        ["@label"] = colors.Red,
        ...
        ["@danger"] = colors.Red,
        ["@type"] = colors.Yellow,
        ["@type.delimiter"] = colors.Purple,
        ["@type.brackets"] = colors.Purple,
        ...
        ["@variable.member"] = {fg = c.cyan, fmt = cfg.code_style.variables},
    }
else
    hl.treesitter = {
        ...
        TSKeyword = {fg = c.red, fmt = cfg.code_style.keywords, priority = 90},
